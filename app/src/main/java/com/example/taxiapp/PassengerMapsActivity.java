...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currentLocation != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(passengerLocation).title("Marker in Passenger"));
    ...
    private void startLocationUpdates() {
        ...
        settingsClient.checkLocationSettings(locationSettingsRequest).addOnSuccessListener(PassengerMapsActivity.this,
